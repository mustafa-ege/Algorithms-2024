...
public class Molecule implements Comparable {
    ...
    private ArrayList<String> completeBonds;
    // Constructor
    public Molecule(String id, int bondStrength, List<String> bonds) {
        this.id = id;
        this.bondStrength = bondStrength;
        this.bonds = bonds;
        completeBonds = new ArrayList<>();
        completeBonds.addAll(bonds);
    }
...
//        toMolecule = new ArrayList<>();
    }
    public void addArrivingBond(String from){
        completeBonds.add(from);
    }
    public List<String> getCompleteBonds() {
        return completeBonds;
    }
